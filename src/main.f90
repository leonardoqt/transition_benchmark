program test
	...
	real(dp)   , allocatable :: psi(:), Tv(:,:,:), &
	                            pop_p_npi_dq(:,:), pop_p_npi(:,:), pop_p_hst(:,:), &
	...
	call final_psi_hop_loc01(Ut, Tv, psi_f_loc, pop_p_loc01)
	call final_psi_hop_loc01_alter(Ut, Tv, psi_f_loc, pop_p_loc01_t)
